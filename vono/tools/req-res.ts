...
export function createRequest(req: IncomingMessage, res: ServerResponse): Request {
  let origin =
...
export async function handleNodeResponse(webRes: Response, res: ServerResponse) {
